  ...
  const Movie = props => (    
        <table>
            <tbody>
                ...
                <tr>
                    <td colSpan="2"><input id="changebutton" type="submit" value="Update" /></td>
                </tr>
            </tbody>
        </table>
)
class Update extends React.Component{
    ...
    onSubmit(e)
    {
        ...
        axios.get('http://localhost:5000/movies/' + this.state.movies[SELECTEDINDEX].id)
            .then(res => {
                console.log(res)
        })
        window.location = '/change/' + this.state.movies[SELECTEDINDEX].id
